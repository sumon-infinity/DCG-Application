...
echo ""
echo -e "${BLUE}📁 The release will contain:${NC}"
echo -e "${BLUE}  • DCG-Application-${tag_name}.apk - Android app${NC}"
echo -e "${BLUE}  • DCG-Application-web-${tag_name}.tar.gz - Web build${NC}"
